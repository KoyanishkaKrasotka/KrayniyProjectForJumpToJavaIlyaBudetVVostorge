...
import ru.jumptojava.kinopoiskz.mapper.FilmMapper;
...
public class FilmSearchService {
    ...
    public Page<FilmDto> searchFilms(Integer yearFrom, Integer yearTo, Float ratingFrom, Float ratingTo,
                                     String keyword, int page, int size, String sortBy, String sortDirection) {

        Sort.Direction direction = Sort.Direction.fromString(sortDirection);
        Pageable pageable = PageRequest.of(page, size, Sort.by(direction, sortBy));

        Page<Film> filmsPage = filmRepository.search(yearFrom, yearTo, ratingFrom, ratingTo, keyword, pageable);
